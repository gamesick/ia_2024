...
class SarsaAgent(AbstractModel):
    ...
    def print_Q(self):
        ...
        for state in states:
            ...
            Policy_matrix[matrix_y][matrix_x] = SarsaAgent._action_to_symbol(best_action)
        ...
        for episode in range(1, episodes + 1):
            ...
            while True:
                ...
                if (
                    ...
                    self.Q[(next_state, next_action)] = 0.0  # Initialize with default Q-value
